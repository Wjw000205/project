    ...
    deep_update(
        cfg,
        {
            ...
            "knn_hybrid": {
                ...
                "path": posix_path((run_dir / "knn_shape_bank.pt").relative_to(ROOT)),
            },
