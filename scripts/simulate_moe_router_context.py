...
def read_run_metrics(run_dir: Path, label: str, cfg_path: Path = None) -> Dict[str, Any]:
    ...
    if cfg_path is not None and cfg_path.exists():
        ...
        row.update(
            {
                "router_mode": str(moe_cfg.get("router_mode", "learned")),
...
def main() -> None:
    ...
    ap.add_argument("--out-root", type=str, default="outputs/ETTm1/moe_router_context_ablation_20260420")
    ...
    experiments: List[Dict[str, Any]] = [
        ...
        {
            "name": "penalty_context_w1_no_entropy",
            "patch": {
                "moe": {
                    "router_mode": "penalty_context",
                    "router_penalty_context_weight": 1.0,
    ...
    for exp in experiments:
        ...
        cfg.setdefault("exp", {})
        cfg["exp"]["name"] = f"moe_router_context_{name}"
