...
def main() -> None:
    ...
    ap.add_argument("--out-root", type=str, default="outputs/ETTm1/moe_router_refine_20260420")
    ...
    experiments: List[Dict[str, Any]] = [
        ...
        {
            "name": "context_w2_add_amp_balance_0p01",
            "patch": {
                "moe": {
                    "router_mode": "penalty_context",
                    "router_penalty_context_weight": 2.0,
    ...
    for exp in experiments:
        ...
        cfg.setdefault("exp", {})
        cfg["exp"]["name"] = f"moe_router_refine_{name}"
